...
-- Date        : Tue Jun  2 10:28:15 2026
-- Host        : gec-MS-7D09 running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode synth_stub
--               /home/gec/Desktop/SOFTMAX/microwatt/ip/cordic_softmax/cordic_softmax_stub.vhdl
-- Design      : cordic_softmax
...
entity cordic_softmax is
  ...
  attribute CHECK_LICENSE_TYPE of cordic_softmax : entity is "cordic_softmax,cordic_v6_0_23,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of cordic_softmax : entity is "cordic_softmax,cordic_v6_0_23,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=cordic,x_ipVersion=6.0,x_ipCoreRevision=23,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_ARCHITECTURE=1,C_CORDIC_FUNCTION=4,C_COARSE_ROTATE=0,C_DATA_FORMAT=0,C_XDEVICEFAMILY=artix7,C_HAS_ACLKEN=0,C_HAS_ACLK=1,C_HAS_S_AXIS_CARTESIAN=0,C_HAS_S_AXIS_PHASE=1,C_HAS_ARESETN=0,C_INPUT_WIDTH=16,C_ITERATIONS=0,C_OUTPUT_WIDTH=20,C_PHASE_FORMAT=1,C_PIPELINE_MODE=-2,C_PRECISION=0,C_ROUND_MODE=0,C_SCALE_COMP=0,C_THROTTLE_SCHEME=3,C_TLAST_RESOLUTION=0,C_HAS_S_AXIS_PHASE_TUSER=0,C_HAS_S_AXIS_PHASE_TLAST=0,C_S_AXIS_PHASE_TDATA_WIDTH=16,C_S_AXIS_PHASE_TUSER_WIDTH=1,C_HAS_S_AXIS_CARTESIAN_TUSER=0,C_HAS_S_AXIS_CARTESIAN_TLAST=0,C_S_AXIS_CARTESIAN_TDATA_WIDTH=32,C_S_AXIS_CARTESIAN_TUSER_WIDTH=1,C_M_AXIS_DOUT_TDATA_WIDTH=48,C_M_AXIS_DOUT_TUSER_WIDTH=1}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of cordic_softmax : entity is "yes";
end cordic_softmax;

architecture stub of cordic_softmax is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "aclk,s_axis_phase_tvalid,s_axis_phase_tready,s_axis_phase_tdata[15:0],m_axis_dout_tvalid,m_axis_dout_tdata[47:0]";
